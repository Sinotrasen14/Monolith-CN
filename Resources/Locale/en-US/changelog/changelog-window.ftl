...
changelog-button-new-entries = 更新记录 (有更新!)

# Frontier: Changelog<Upstream
changelog-tab-title-Changelog = 更新记录
changelog-tab-title-Admin = 管理

cmd-changelog-desc = 打开修改日志
cmd-changelog-help = 用法：日志
