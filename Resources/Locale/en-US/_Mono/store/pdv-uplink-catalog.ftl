...
uplink-pirate-rad-pen-name = 放射自动注射器
uplink-pirate-rad-pen-desc = 快速反辐射药剂。含有硫化嗪和双卡啶。

uplink-pirate-combat-medkit-name = 战斗医疗箱
uplink-pirate-combat-medkit-desc = 包含治疗外伤、淤伤和失血的医疗包。

uplink-pirate-combat-pen-name = 战斗医疗笔
uplink-pirate-combat-pen-desc = 一种通用注射剂，装在自动注射器中。

uplink-pirate-syringe-case-name = 医疗笔盒
uplink-pirate-syringe-case-desc = 一个装满医疗笔的小口袋盒，应对大多数战斗场景。

uplink-pirate-hyperzine-name = 高能注射器
uplink-pirate-hyperzine-desc = 战斗兴奋剂，可以防止眩晕并提高你的移动能力。持续30秒。

uplink-pirate-surgery-name = 手术包
uplink-pirate-surgery-desc = 一个外科手术套件，里面包含了挽救朋友或分解敌人所需的最基本东西。

uplink-pirate-omnizine-jug-name = 全锌酒壶
uplink-pirate-omnizine-jug-desc = 一壶全锌，可以用来制作医疗笔并维持你队友的生命。悄悄从和谐医疗企业进口。

uplink-pirate-medical-assembler-name = 医疗组装平板包
uplink-pirate-medical-assembler-desc = 一个可以用来制作有用医疗用品的组装器。
...
uplink-pirate-syndicate-magboots-name = 战术磁靴
uplink-pirate-syndicate-magboots-desc = 一双防滑的靴子，在零重力环境下可以让你正常移动，但会略微变慢。此外，它们还带有喷气背包功能，并且自带燃料，但持续时间不长。

uplink-pirate-syndicate-jetpack-name = 黑色喷气背包
uplink-pirate-syndicate-jetpack-desc = 一个黑色的喷气背包。它可以让你在太空中飞行。不包括补充燃料，请明智地使用你的燃料。
...
uplink-pirate-radio-jammer-desc = 这个装置一旦启动，会干扰周围的所有外发无线电通讯以及服装传感器。

uplink-pirate-hypopen-name = Hypopen
uplink-pirate-hypopen-desc = uplink-pirate-hypopen-desc = 一种伪装成笔的化学低压喷射器，能够瞬间注射最多10微升的试剂。初始为空。

uplink-pirate-implanter-freelance-name = 先锋植入器
uplink-pirate-implanter-freelance-desc = 植入先锋无线电，可以不戴耳机进行隐蔽通信。

uplink-pirate-emag-name = 加密排序器
uplink-pirate-emag-desc = 一种多功能黑客设备，可以配置一些机器的工作方式。

uplink-pirate-access-breaker-name = 认证破坏者
uplink-pirate-access-breaker-desc = 一种可以覆盖机器或门上的访问读卡器的设备，让你可以自由进入。

uplink-pirate-jaws-name = 先进液压钳
uplink-pirate-jaws-desc = 一个普通的液压钳被非法改装过限制，能够比普通的液压钳开门快两倍。

uplink-pirate-thruster-kit-name = 推进器升级套件
uplink-pirate-thruster-kit-desc = 包含32个超级电容器。非常适合升级八个推进器。

uplink-pirate-comms-computer-circuitboard-name = PDV 通信电脑板
uplink-pirate-comms-computer-circuitboard-desc = 用于 PDV 通讯控制台的计算机印刷电路板。

uplink-pirate-security-cyborg-module-name = 安全机器人模块
uplink-pirate-security-cyborg-module-desc = 一把砍刀、一把能量枪，还有一根电击棒，专门为机械人制造的。等等，TFSMC不是也有一样的吗？

uplink-pirate-cash10000-name = 10,000 信用点
uplink-pirate-cash10000-desc = That's my boy, you made my day.

uplink-pirate-cash100000-name = 100,000 信用点
uplink-pirate-cash100000-desc = That's my boy, you really made my day.
# desc is quote

uplink-syndicate-applicator-name = 高级纳米修复器
uplink-syndicate-applicator-desc = 高级纳米机器人修复器，纳米容量大幅升级，能够自行生成纳米机器人。
...
uplink-pirate-kanabou-name = 棒子
uplink-pirate-kanabou-desc = 一件适合不讲究细腻的人使用的武器。特别适合鬼使用。

uplink-pirate-ak-name = AKM
uplink-pirate-ak-desc = 一款标志性的战争武器。使用7.62x39毫米弹药。

uplink-pirate-laser-gun-name = 复古激光枪
uplink-pirate-laser-gun-desc = 一种民用等级的武器，使用受激辐射放大的光。
...
uplink-pirate-blueprint-launcher-rocket-name = RPG-7 蓝图
uplink-pirate-blueprint-launcher-rocket-desc = RPG-7及其弹药的蓝图。对长期恐怖活动有用！

uplink-pirate-grenade-launcher-bundle-name = 中国湖套装
uplink-pirate-grenade-launcher-bundle-desc = 噗!

# MARK: Ammo

uplink-pirate-box-magazine-pistol-name = 一盒9x19毫米手枪弹匣
uplink-pirate-box-magazine-pistol-desc = 一个装有4个9x19毫米手枪弹匣的盒子。
...
uplink-pirate-shell-box-lethal-name = 弹壳箱（致命）
uplink-pirate-shell-box-lethal-desc = 一盒装有16发12号猎枪子弹。

uplink-pirate-smg-ammo-box-name = 弹药箱（9x19毫米全金属被甲）
uplink-pirate-smg-ammo-box-desc = 一个装有60发9x19毫米手枪子弹的盒子。可以用来给冲锋枪弹匣上子弹。

uplink-pirate-box-bulldog-ammo-name = 12号霰弹桶装一盒
uplink-pirate-box-bulldog-ammo-desc = 一箱装有4个12号口径鹿弹霰弹枪弹鼓。

uplink-pirate-box-bulldog-slug-ammo-name = 12号口径弹丸桶装一箱
uplink-pirate-box-bulldog-slug-ammo-desc = 一个装有4个12号口径弹头霰弹枪弹鼓的盒子。

uplink-pirate-box-smg-magazine-name = 一盒9x19毫米冲锋枪弹匣
uplink-pirate-box-smg-magazine-desc = 一个装着三本9x19毫米冲锋枪弹匣的盒子。

uplink-subsonic-mag-name = 7.62x39mm 亚音速步枪弹匣
uplink-subsonic-mag-desc = 支持WSPR。

uplink-subsonic-box-name = 7.62x39mm 亚音速步枪弹盒
uplink-subsonic-box-desc = 一盒WSPR用的弹药。

uplink-pirate-box-highcal-name = 12.7x99mm弹药盒
uplink-pirate-box-highcal-desc = 一盒适用于燃烧者重型步枪的通用弹药。
...
uplink-pirate-frag-grenade-name = 破片榴弹
uplink-pirate-frag-grenade-desc = 一种用于中国湖步枪的广泛破坏性40毫米破片手榴弹。在广阔区域内摧毁一切。

uplink-pirate-blast-grenade-name = 爆破榴弹
uplink-pirate-blast-grenade-desc = 一款用于中国湖的高致命性40毫米热压榴弹。在一个精确半径内破坏力极强。

# MARK: Equipment

uplink-pirate-combat-hardsuit-name = SCAF 战术服
uplink-pirate-combat-hardsuit-desc = PDV 军事小组的基本防护装备。

uplink-pirate-viper-group-standard-hardsuit-name = 蝰蛇集团豺狼硬装
uplink-pirate-viper-group-standard-hardsuit-desc = 一套厚重的硬装，上面装饰着毒蛇集团的标志性标记。这套盔甲在提供保护的同时非常灵活，还内置了夜视系统。

uplink-pirate-viper-group-medic-hardsuit-name = 毒蛇小组 IMP 硬装
uplink-pirate-viper-group-medic-hardsuit-desc = 一套轻型硬壳战衣，饰有毒蛇集团的标志性标记。护甲在关键部位有多处加强装甲，并配备医疗HUD和热脉冲系统。
